                        ...
                        <div class="col-lg-5">
                            <div class="card shadow-lg border-0 rounded-lg mt-5">
                                <div class="card-header text-center">
                                    <img class="img" src="src/logo.png" width="100">
            ...
            <footer class="py-4 bg-light mt-auto">
                <div class="container-fluid">
                    <div class="d-flex align-items-center justify-content-between small">
                        <div class="text-muted">Copyright &copy; <a href="https://transmarket.pe" target="_blank" rel="noopener noreferrer">TransMarket</a> <?php echo date("Y"); ?></div>
                        <div>
                            <a href="https://transmarket.pe/politica-privacidad/">Politica de Privacidad </a>
                            &middot;
                            <a href="https://transmarket.pe/libro-de-reclamaciones/">Libro de Reclamaciones</a>
                        </div>
                    </div>
                </div>
            </footer>
